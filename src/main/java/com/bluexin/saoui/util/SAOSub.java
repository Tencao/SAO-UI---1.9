...
public final class SAOSub {
    ...
    private static SAOMenuGUI setFriendsSub(Minecraft mc, SAOMenuGUI sub) {
        ...
        if (onlineCount > 0) {
            ...
            sub.elements.add(new SAOLabelGUI(sub, 0, 0, '-' + I18n.translateToLocal("guiFriends") + '-', SAOAlign.CENTER));
    ...
    private static SAOMenuGUI setPartySub(Minecraft mc, SAOMenuGUI sub) {
        ...
        if (party != null) {
            ...
            sub.elements.add(new SAOLabelGUI(sub, 0, 0, '-' + I18n.translateToLocal("guiParty") + '-', SAOAlign.CENTER));
            sub.elements.add(new SAOTextGUI(sub, 0, 0, builder.toString()));
        } else setEmptySub(mc, sub);
    ...
    private static SAOMenuGUI setQuestsSub(Minecraft mc, SAOMenuGUI sub, EntityPlayer player) {
        sub.elements.add(new SAOLabelGUI(sub, 0, 0, sub.width, '-' + I18n.translateToLocal("guiQuestList") + '-', SAOAlign.CENTER));
        ...
        if (stats != null) {
            final List<Achievement> ach = AchievementList.ACHIEVEMENTS;
            ach.stream()
    ...
    public static SAOString[] addProfileContent(EntityPlayer player) {
        return new SAOString[]{
                new SAOJString(I18n.translateToLocal("guiProfile")), new SAOPlayerString(player)
        };
    }
