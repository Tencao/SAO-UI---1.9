       ...
       if (replaceEvent(HOTBAR)) return;
        ...
        if (mc.playerController.isSpectator()) this.spectatorGui.renderTooltip(res, partialTicks);
            ...
            for (int i = 0; i < slotCount; i++) {
                SAOGL.glColorRGBA(i == inv.currentItem ? 0xFFBA66FF : 0xCDCDCDAA);
            ...
            if (itemstack != null)
            {
                ...
                {
                    SAOGL.glColorRGBA(0xFFBA66FF);
                    SAOGL.glTexturedRect(w - 91 - 29, res.getScaledHeight() - 23, zLevel, 0, 25, 20, 20);
                }
                else
                {
                    SAOGL.glColorRGBA(0xCDCDCDAA);
                    SAOGL.glTexturedRect(w + 91, res.getScaledHeight() - 23, zLevel, 0, 25, 20, 20);
                }
            }
            ...
            if (itemstack != null)
            {
                ...
                {
                    SAOGL.glColorRGBA(0xFFBA66FF);
                    SAOGL.glTexturedRect(res.getScaledWidth() - 24, y, zLevel, 0, 25, 20, 20);
                }
                else
                {
                    SAOGL.glColorRGBA(0xCDCDCDAA);
