...
public class SAOIngameMenuGUI extends SAOScreenGUI {
    ...
    private void openMenu(SAOElementGUI element, SAOID id) {
        ...
        if (id == SAOID.PROFILE) {
            ...
            menu.elements.add(new SAOButtonGUI(menu, SAOID.EQUIPMENT, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiEquipment"), SAOIcon.EQUIPMENT));
            menu.elements.add(new SAOButtonGUI(menu, SAOID.ITEMS, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiItems"), SAOIcon.ITEMS));
            menu.elements.add(new SAOButtonGUI(menu, SAOID.SKILLS, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiSkills"), SAOIcon.SKILLS));
            ...
            menu.elements.add(new SAOButtonGUI(menu, SAOID.GUILD, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiGuild"), SAOIcon.GUILD));
            menu.elements.add(new SAOButtonGUI(menu, SAOID.PARTY, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiParty"), SAOIcon.PARTY));
            menu.elements.add(new SAOButtonGUI(menu, SAOID.FRIENDS, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiFriends"), SAOIcon.FRIEND));
            ...
            menu.elements.add(new SAOButtonGUI(menu, SAOID.MESSAGE_BOX, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiMessageBox"), SAOIcon.MESSAGE));
            ...
            menu.elements.add(new SAOButtonGUI(menu, SAOID.QUESTS, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiQuest"), SAOIcon.QUEST));
            if (SAOOption.DEBUG_MODE.getValue()) menu.elements.add(new SAOButtonGUI(menu, SAOID.FIELD_MAP, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiFieldMap"), SAOIcon.FIELD_MAP));
            if (SAOOption.DEBUG_MODE.getValue()) menu.elements.add(new SAOButtonGUI(menu, SAOID.DUNGEON_MAP, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiDungMap"), SAOIcon.DUNGEON_MAP));
            ...
            menu.elements.add(new SAOButtonGUI(menu, SAOID.OPTIONS, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiOption"), SAOIcon.OPTION));
            menu.elements.add(new SAOButtonGUI(menu, SAOID.MENU, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiMenu"), SAOIcon.HELP));
            menu.elements.add(new SAOStateButtonGUI(menu, SAOID.LOGOUT, 0, 0, SAOOption.LOGOUT.getValue() ? net.minecraft.util.text.translation.I18n.translateToLocal("guiLogout") : "", SAOIcon.LOGOUT, (mc1, button) -> {
                if (SAOOption.LOGOUT.getValue()) {
        ...
        //Profile
            ...
            menu.elements.add(new SAOButtonGUI(menu, SAOID.TOOLS, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiTools"), SAOIcon.EQUIPMENT));
            menu.elements.add(new SAOButtonGUI(menu, SAOID.ARMOR, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiEquipped"), SAOIcon.ARMOR));
            if (SAOInventory.isBaublesLoaded()) menu.elements.add(new SAOButtonGUI(menu, SAOID.ACCESSORY, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiAccessory"), SAOIcon.ACCESSORY));
            menu.elements.add(new SAOButtonGUI(menu, SAOID.CONSUMABLES, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiConsumable"), SAOIcon.ITEMS));
        ...
        //Profile -> Equipment
            ...
            if (SAOOption.COMPACT_INVENTORY.getValue()){
                ...
                menu = new SAOMenuGUI(element, menuOffsetX, menuOffsetY, 100, 60);
                if (mc.thePlayer.inventoryContainer.getInventory().stream().filter(st -> st != null).anyMatch(st -> SAOInventory.WEAPONS.isFine((ItemStack) st, true))) menu.elements.add(new SAOButtonGUI(menu, SAOID.WEAPONS, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiWeapons"), SAOIcon.EQUIPMENT));
                if (mc.thePlayer.inventoryContainer.getInventory().stream().filter(st -> st != null).anyMatch(st -> SAOInventory.BOWS.isFine((ItemStack) st, true))) menu.elements.add(new SAOButtonGUI(menu, SAOID.BOWS, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiBows"), SAOIcon.EQUIPMENT));
                if (mc.thePlayer.inventoryContainer.getInventory().stream().filter(st -> st != null).anyMatch(st -> SAOInventory.PICKAXE.isFine((ItemStack) st, true))) menu.elements.add(new SAOButtonGUI(menu, SAOID.PICKAXE, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiPickaxes"), SAOIcon.EQUIPMENT));
                if (mc.thePlayer.inventoryContainer.getInventory().stream().filter(st -> st != null).anyMatch(st -> SAOInventory.AXE.isFine((ItemStack) st, true))) menu.elements.add(new SAOButtonGUI(menu, SAOID.AXE, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiAxes"), SAOIcon.EQUIPMENT));
                if (mc.thePlayer.inventoryContainer.getInventory().stream().filter(st -> st != null).anyMatch(st -> SAOInventory.SHOVEL.isFine((ItemStack) st, true))) menu.elements.add(new SAOButtonGUI(menu, SAOID.SHOVEL, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiShovels"), SAOIcon.EQUIPMENT));
        ...
        //Social
            ...
            menu.elements.add(new SAOPartyGUI(menu, SAOID.INVITE_LIST, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiInvite"), SAOIcon.INVITE));
            menu.elements.add(new SAOPartyGUI(menu, SAOID.DISSOLVE, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiDissolve"), SAOIcon.CANCEL));
        ...
        //Social -> Friends
            ...
            if (((SAOFriendGUI) element).highlight) {
                ...
                menu = new SAOMenuGUI(element, menuOffsetX, menuOffsetY, 100, 60);
                menu.elements.add(new SAOButtonGUI(menu, SAOID.POSITION_CHECK, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiPositionCheck"), SAOIcon.FIELD_MAP));
                menu.elements.add(new SAOButtonGUI(menu, SAOID.OTHER_PROFILE, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiProfile"), SAOIcon.PARTY));
            } else {
                menu = null;
        ...
        //Navigation
            ...
            sub = SAOSub.resetCheckPositionSub(mc, sub, mc.thePlayer, 4, '-' + net.minecraft.util.text.translation.I18n.translateToLocal("guiFieldMap") + '-');
            info = SAOSub.addInfo(sub);
            ...
            sub = SAOSub.resetCheckPositionSub(mc, sub, mc.thePlayer, 1, '-' + net.minecraft.util.text.translation.I18n.translateToLocal("guiDungMap") + '-');
            info = SAOSub.addInfo(sub);
