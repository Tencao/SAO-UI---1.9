...
import com.bluexin.saoui.util.J8String;
import com.bluexin.saoui.screens.window.ScreenGUI;
import com.bluexin.saoui.screens.window.SubWindow;
...
import com.bluexin.saoui.screens.*;
import com.bluexin.saoui.screens.buttons.*;
import com.bluexin.saoui.screens.ingame.IngameGUI;
import com.bluexin.saoui.screens.inventory.InventoryCore;
import com.bluexin.saoui.screens.inventory.InventoryGUI;
import com.bluexin.saoui.screens.window.ui.AchievementList;
import com.bluexin.saoui.social.StaticPlayerHelper;
import com.bluexin.saoui.social.friends.FriendList;
import com.bluexin.saoui.social.friends.FriendCore;
import com.bluexin.saoui.social.party.PartyHelper;
import com.bluexin.saoui.social.party.PartyHandler;
...
public class IngameMenuGUI extends ScreenGUI {
    ...
    private void openMenu(Elements element, Categories id) {
        ...
        if (id == Categories.PROFILE) {
            ...
            if (OptionCore.DEBUG_MODE.getValue()) menu.elements.add(new ButtonGUI(menu, Categories.FIELD_MAP, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiFieldMap"), IconCore.FIELD_MAP));
            if (OptionCore.DEBUG_MODE.getValue()) menu.elements.add(new ButtonGUI(menu, Categories.DUNGEON_MAP, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiDungMap"), IconCore.DUNGEON_MAP));
        ...
        //Profile
            ...
            if (InventoryCore.isBaublesLoaded()) menu.elements.add(new ButtonGUI(menu, Categories.ACCESSORY, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiAccessory"), IconCore.ACCESSORY));
        ...
        //Profile -> Equipment
            ...
            if (OptionCore.COMPACT_INVENTORY.getValue()){
                ...
                menu = new MenuGUI(element, menuOffsetX, menuOffsetY, 100, 60);
                if (mc.thePlayer.inventoryContainer.getInventory().stream().filter(st -> st != null).anyMatch(st -> InventoryCore.WEAPONS.isFine((ItemStack) st, true))) menu.elements.add(new ButtonGUI(menu, Categories.WEAPONS, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiWeapons"), IconCore.EQUIPMENT));
                if (mc.thePlayer.inventoryContainer.getInventory().stream().filter(st -> st != null).anyMatch(st -> InventoryCore.BOWS.isFine((ItemStack) st, true))) menu.elements.add(new ButtonGUI(menu, Categories.BOWS, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiBows"), IconCore.EQUIPMENT));
                if (mc.thePlayer.inventoryContainer.getInventory().stream().filter(st -> st != null).anyMatch(st -> InventoryCore.PICKAXE.isFine((ItemStack) st, true))) menu.elements.add(new ButtonGUI(menu, Categories.PICKAXE, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiPickaxes"), IconCore.EQUIPMENT));
                if (mc.thePlayer.inventoryContainer.getInventory().stream().filter(st -> st != null).anyMatch(st -> InventoryCore.AXE.isFine((ItemStack) st, true))) menu.elements.add(new ButtonGUI(menu, Categories.AXE, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiAxes"), IconCore.EQUIPMENT));
                if (mc.thePlayer.inventoryContainer.getInventory().stream().filter(st -> st != null).anyMatch(st -> InventoryCore.SHOVEL.isFine((ItemStack) st, true))) menu.elements.add(new ButtonGUI(menu, Categories.SHOVEL, 0, 0, net.minecraft.util.text.translation.I18n.translateToLocal("guiShovels"), IconCore.EQUIPMENT));
